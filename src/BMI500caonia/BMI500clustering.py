...
n_classes: how many classes for clustering
iteration: iterations
random_state: how many time we try different inilization. We only output the one with the minimum inter-class sum of distance.
